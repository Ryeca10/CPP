...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cppapplication_2: ${OBJECTFILES}
	...
	${LINK.c} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cppapplication_2 ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/newCSimpleTest.o: newCSimpleTest.c 
	${MKDIR} -p ${OBJECTDIR}
